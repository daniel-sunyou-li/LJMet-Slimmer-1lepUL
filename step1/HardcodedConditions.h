...
public:
    ...
    void GetJetVetoMap( double eta, double phi, std::string year );
...
private:
    void GetJetVetoMap2016( double eta, double phi );
    void GetJetVetoMap2017( double eta, double phi );
    void GetJetVetoMap2018( double eta, double phi );
    ...
    void GetJetPileupIDEff2016APV( double pt, double eta, double *puJetIDEff );
    void GetJetPileupIDEff2016( double pt, double eta, double *puJetIDEff );
    void GetJetPileupIDEff2017( double pt, double eta, double *puJetIDEff );
    void GetJetPileupIDEff2018( double pt, double eta, double *puJetIDEff );
